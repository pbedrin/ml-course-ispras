...
from tasks import euclidean_distance, cosine_distance, manhattan_distance
...
class ManhattanDistanceTest(TestCase):
    def test_base_scenario_norm(self):
        ...
        xx_pred = manhattan_distance(x, x)
        xx_true = cdist(x, x, metric='cityblock')
    ...
    def test_base_scenario_common(self):
        ...
        xx_pred = manhattan_distance(x, y)
        xx_true = cdist(x, y, metric='cityblock')
